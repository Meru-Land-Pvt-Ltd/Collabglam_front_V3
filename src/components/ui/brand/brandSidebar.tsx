                ...
                <>
                  <div className="relative">
                    ...
                    <button
                      ...
                      className={cn(
                        "absolute -right-2 -top-2 z-10 grid h-5 w-5 place-items-center rounded-full text-[#1a1a1a] transition hover:bg-neutral-100",
                      )}
                    >
                ...
                <>
                  ...
                  >
                    <button
                      ...
                      onClick={handleHideSubscriptionCard}
                      className={cn(
                        "absolute right-2 top-2 z-20 grid h-7 w-7 place-items-center text-[#1a1a1a] transition hover:text-black cursor-pointer",
                        FOCUS_RING
                      )}
                    >
