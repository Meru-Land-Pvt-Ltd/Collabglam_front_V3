...
export default function ViewDeleverablePage() {
  ...
  const fetchDeliverables = useCallback(async () => {
    ...
    try {
      ...
      const deliverables = extractDeliverables(res);
  ...
  }, [milestoneId, campaignId, statusFilter]);
          ...
          <div className="flex flex-col gap-4 p-5 md:flex-row md:items-center md:justify-between md:p-6">
            <div className="space-y-1">
              ...
              <p className="text-sm text-slate-500">
                See all deliverables submitted for this milestone.
              </p>
            </div>
              ...
              <table className="min-w-full text-sm">
                ...
                <tbody className="divide-y divide-slate-100">
                  {rows.map((row, index) => {
                    ...
                    return (
                      <tr key={rowId} className="transition-colors hover:bg-slate-50/80">
                        ...
                        <td className="px-5 py-4 align-top text-slate-700">
                          <div className="max-w-[220px] line-clamp-2">
                            {row.milestoneTitle || row.milestoneId || "-"}
                          </div>
                        </td>
